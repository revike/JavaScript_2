...
const app = new Vue({
    ...
    methods: {
        ...
        addProduct(product){
            ...
            if (this.basket == '') {
                return this.basket.push(result);
            } else {
                for (let i=0; i < this.basket.length; i++) {
                    if (this.basket[i].id_product == product.id_product) {
                        return this.basket[i].quantity += 1;
                    }
                }
        ...
        delProduct(product){
            ...
            let cartEmpty = document.querySelector(".cart-empty");
            if (this.basket == '' & !cartEmpty) {
                let p = document.createElement('p');
                cart.appendChild(p).classList.add('cart-empty');
        ...
        FilterGoods() {
            ...
            if (text == '') {
                ...
                this.filter = this.products.filter((el) => {
